...
*Prototype built for the SMART ERA application, September–October 2026. Sample data.* — generated 2026-09-09T22:07:47+00:00 by `python -m app.cli grounding-test` / `tests/test_grounding.py`.
